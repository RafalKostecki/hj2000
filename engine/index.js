const IisStruct = new Interface('IisStruct', ['createStruct', 'changePosition'], ['A', 'B', 'C', 'D', 'id']);
const IisChar = new Interface('IisChar', ['move', 'jump'], ['life']);
const IisPlayer = new Interface('IisPlayer', ['crouch', 'gainPoints'], ['score', 'isCrouching', 'id']);
const IisGainPoint = new Interface('IisGainPoint', ['create'], ['gainPoint', 'id']);

game; //Init game
game = new Game();

Game.prototype.setWindow();
