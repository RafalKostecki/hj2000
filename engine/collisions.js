const Collisions = (function() { //Singleton
    let instance;
    ...
    return class {
        ...
        endJump(char) {
            IisChar.isIplementedBy(char);
            //I oguth to check where was call this method and if this was in char.jump I run fallingSystem in another cases not.
            fallingSystem(char)
        }
    }
})();
