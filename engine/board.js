const Board = (function() {
  ...
  return class {
    constructor(lvl) {
      ...
      this.requiredPoints = levels[_(this).level][1].length;
      this.endPoint = levels[_(this).level][2];

      this.width = levels[_(this).level][0][2];
      this.height = levels[_(this).level][0][3];

      gameBoard.style.width = this.width;
      gameBoard.style.height = this.height;
    };
    ...
    setEndPoint() {
      ...
      endPoint.style.left = this.endPoint[0];
      endPoint.style.top = this.endPoint[1];
